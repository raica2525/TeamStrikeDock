...
// Author : 後藤慎之助
//=============================================================================
CPlayer * CPlayer::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, int nStock, int playable, AI_LEVEL AIlevel)
{
    // メモリ確保
...
// Author : 後藤慎之助
//=============================================================================
void CPlayer::TakeDamage(float fDamage, int nWho, D3DXVECTOR3 damageOldPos, bool bUseLuckyGuard, bool bSetOff)
{
    // 生存しているなら
    if (m_bDisp)
    {
